...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=1\linewidth]{SideQuestUserFlowDiagram.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=1\linewidth]{SideQuestArchitectureDiagram.png}
...
\begin{figure}[!t]
  ...
  \begin{minipage}[t]{0.32\linewidth}
    \centering
    \includegraphics[width=\linewidth]{AppPhotos/Sidequest_Profile.PNG}
